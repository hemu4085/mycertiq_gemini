/**
 * CME Planner Concierge Grid Implementation (v1.2.9)
 * Execution Mode: Manual Edit
 * Path: /home/myunix/projects/mycertiq_gemini/frontend/src/components/CMEPlanner.tsx
 * Update: Removed Plus icon; replaced with text-based "Add" button that toggles to "Added".
 * Constraints: Filters, state lists, and 20 sample data items preserved from Patch #163.
 */
...
export const CMEPlanner = ({ cmeStatus = DEFAULT_CME_STATUS }: any) => {
  ...
  const allCourses = useMemo(() => [
    ...
    { 
      ...
      registrationLink: "#", tags: ['Family & Fun', 'Theme Parks/Amusement'], isWellness: false 
    },
    { 
                ...
                <div key={course.id} className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
                  <div className="p-5 border-b border-slate-50 bg-slate-50/50">
                    <div className="flex justify-between items-start mb-2">
                      <a href={course.officialListing} target="_blank" className="text-lg font-black text-slate-900 hover:text-[#155DFC] leading-tight group">
                  ...
                  <div className="p-5 flex-grow space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[11px] pt-2 border-t border-slate-100">
                      ...
                      <div>
                        ...
                        {course.golfLink && <a href={course.golfLink} className="block text-emerald-600 font-bold hover:underline">⛳ Nearby Golf</a>}
